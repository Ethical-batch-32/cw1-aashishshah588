...
$conn = mysqli_connect('localhost','root','','connect_db');
...
if(isset($_POST['send'])){
   ...
   $insert = "INSERT INTO `connect_form`(`name`, `email`, `number`, `plan`, `address`, `message`) VALUES ('$name','$email','$number','$plan','$address','$message')";
